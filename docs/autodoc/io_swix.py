...
def read_binary(x, filename):
    ...
    :type x: vector, matrix
    :param filename: Where to write the file.
    :type filename: String
    :return: The contents of the file. Either an vector or matrix.
    """
...
def write_binary(x, filename):
    ...
    :param filename: Where to write the file.
    :type filename: String
    .. seealso:: `np.fromfile`_, `vector.tofile`_
...
def read_csv(filename):
    ...
    :param header_present: If false, the first row will be included as part of
        ...
        returned.
    :rtype: vector. The contents of the csv.
...
def write_csv(x, filename, header):
    ...
    :param x: The vector to write to a csv
    :type x: vector, matrix, CSVFile
