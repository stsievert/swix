# -*- coding: utf-8 -*-
#
# swix documentation build configuration file, created by
...
sys.path.append('/Users/scott/Developer/swix/docs/')
...
project = u'swix'
copyright = u'2014, Scott Sievert'
...
# template names.
#html_additional_pages = {'numbers.html'}
...
latex_documents = [
  ('index', 'swix.tex', u'swix Documentation',
   u'Scott Sievert', 'manual'),
]
...
man_pages = [
    ('index', 'swix', u'swix Documentation',
     [u'Scott Sievert'], 1)
]
...
texinfo_documents = [
  ('index', 'swix', u'swix Documentation',
   u'Scott Sievert', 'swix', 'One line description of project.',
   'Miscellaneous'),
]
